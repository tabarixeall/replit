...
import { updateXmlSchema, type UpdateXmlRequest, type XmlSettings } from "@shared/schema.js";
...
export default function XmlSettingsPage() {
  ...
  const form = useForm<UpdateXmlRequest>({
    ...
    defaultValues: {
      introFile: "intro.wav",
      outroFile: "outro.wav",
      connectAction: "https://oxyp1-1.onrender.com/connect",
      inputTimeout: 50000,
      waitTime: 2,
    }
  });
  ...
  useEffect(() => {
    if (settings) {
      form.reset({
        ...
        connectAction: settings.connectAction || "https://oxyp1-1.onrender.com/connect",
